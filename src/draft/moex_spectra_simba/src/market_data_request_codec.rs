...
pub mod encoder {
    ...
    impl<'a> MarketDataRequestEncoder<'a> {
        ...
        /// - encodedLength: 4
        #[inline]
        pub fn appl_beg_seq_num(&mut self, value: u32) {
            let offset = self.offset;
            self.get_buf_mut().put_u32_at(offset, value);
        }

        /// primitive field 'ApplEndSeqNum'
        /// - min value: 0
        /// - max value: 4294967294
        /// - null value: 4294967295
        /// - characterEncoding: null
        ...
        /// - encodedLength: 4
        #[inline]
        pub fn appl_end_seq_num(&mut self, value: u32) {
...
pub mod decoder {
    ...
    impl<'a> MarketDataRequestDecoder<'a> {
        ...
        #[inline]
        pub fn appl_beg_seq_num(&self) -> u32 {
            self.get_buf().get_u32_at(self.offset)
        }

        /// primitive field - 'REQUIRED'
        #[inline]
        pub fn appl_end_seq_num(&self) -> u32 {
