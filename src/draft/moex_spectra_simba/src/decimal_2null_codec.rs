...
pub mod encoder {
    ...
    pub struct Decimal2NULLEncoder<P> {
        parent: Option<P>,
        offset: usize,
    }

    impl<'a, P> Writer<'a> for Decimal2NULLEncoder<P> where P: Writer<'a> + Default {
        #[inline]
    ...
    impl<'a, P> Decimal2NULLEncoder<P> where P: Writer<'a> + Default {
...
pub mod decoder {
    ...
    #[derive(Debug, Default)]
    pub struct Decimal2NULLDecoder<P> {
        parent: Option<P>,
        offset: usize,
    }

    impl<'a, P> Reader<'a> for Decimal2NULLDecoder<P> where P: Reader<'a> + Default {
        #[inline]
    ...
    impl<'a, P> Decimal2NULLDecoder<P> where P: Reader<'a> + Default {
        pub fn wrap(mut self, parent: P, offset: usize) -> Self {
            self.parent = Some(parent);
            self.offset = offset;
            self
