...
pub mod encoder {
    ...
    pub struct OrderExecutionEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for OrderExecutionEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for OrderExecutionEncoder<'a> {
        #[inline]
    ...
    impl<'a> OrderExecutionEncoder<'a> {
        ...
        /// COMPOSITE ENCODER
        #[inline]
        pub fn last_px_encoder(self) -> Decimal5Encoder<Self> {
...
pub mod decoder {
    ...
    pub struct OrderExecutionDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> Reader<'a> for OrderExecutionDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for OrderExecutionDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> OrderExecutionDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        /// COMPOSITE DECODER
        #[inline]
        pub fn last_px_decoder(self) -> Decimal5Decoder<Self> {
            let offset = self.offset + 24;
        ...
        /// primitive field - 'REQUIRED'
        #[inline]
        pub fn trade_id(&self) -> i64 {
            self.get_buf().get_i64_at(self.offset + 40)
        }

        #[inline]
        pub fn md_flags(&self) -> MDFlagsSet {
            MDFlagsSet::new(self.get_buf().get_u64_at(self.offset + 48))
        }

        #[inline]
        pub fn md_flags_2(&self) -> MDFlags2Set {
            MDFlags2Set::new(self.get_buf().get_u64_at(self.offset + 56))
        }
        ...
        pub fn rpt_seq(&self) -> u32 {
            self.get_buf().get_u32_at(self.offset + 68)
        }
